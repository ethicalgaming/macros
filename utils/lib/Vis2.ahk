...
#include utils\lib\Gdip_All.ahk
#include utils\lib\ImagePut.ahk
#include utils\lib\JSON.ahk
...
class provider {
   ...
   convert(in:=""){
      ...
      class Tesseract {
         ...
         static leptonica := A_ScriptDir "\utils\bin\leptonica_util\leptonica_util.exe"
         static tesseract := A_ScriptDir "\utils\bin\tesseract\tesseract.exe"
         static tessdata_best := A_ScriptDir "\utils\bin\tesseract\tessdata_best"
         static tessdata_fast := A_ScriptDir "\utils\bin\tesseract\tessdata_fast"
